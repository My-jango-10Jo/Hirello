package com.sparta.hirello.secondary.security;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.sparta.hirello.primary.user.dto.request.LoginRequest;
import com.sparta.hirello.primary.user.entity.UserRole;
import com.sparta.hirello.primary.user.service.RefreshTokenService;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest req, HttpServletResponse res, FilterChain chain, Authentication authResult) throws IOException {
        ...
        String json = new ObjectMapper().writeValueAsString(
                new AuthResponse(SC_OK, "로그인 성공", accessToken, refreshToken)
        );
    ...
    protected void unsuccessfulAuthentication(HttpServletRequest req, HttpServletResponse res, AuthenticationException failed) throws IOException {
        ...
        // JSON 응답 생성
        String json = new ObjectMapper().writeValueAsString(
                new AuthResponse(SC_UNAUTHORIZED, "로그인 실패: " + failed.getMessage(), null, null)
        );
